...
// aSide.append(scene.domElement);
//var canv = document.createElement("scene");
//canv.setAttribute("id", "aSide");
...
// div.append(scene)
// body.append(div)
var camera = new THREE.PerspectiveCamera(75,window.innerHeight/window.innerHeight,0.01,1000);  
